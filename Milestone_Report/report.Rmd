...
-   Uni-gram matrix with the threshold of 1000 times:

```{r}
uni.gram.threshold <- findFreqTerms(uni.gram.matrix, lowfreq=1000)
...
uni.gram < uni.gram[order(-uni.gram$frequency),]
...
```{r}
write.csv(uni.gram, file="../Data/n-gram/uni-gram", row.names=FALSE)
write.csv(bi.gram, file="../Data/n-gram/bi-gram", row.names=FALSE)
write.csv(tri.gram, file="../Data/n-gram/tri-gram", row.names=FALSE)
```
